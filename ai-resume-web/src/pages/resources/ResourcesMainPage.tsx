  ...
  return (
    <PublicLayout>
      <ResourceLayout>
        {/* Header */}
        <div className="mb-10">
          <h1 className="text-3xl font-bold text-[#E8E4DE] mb-2">{t('resources.title')}</h1>
          <p className="text-[#8A8580]">{t('resources.subtitle')}</p>
        </div>
        ...
        <div className="mb-8">
          <div className="flex gap-3">
            <input
              ...
              className="flex-1 bg-[#161616] border border-[#252525] rounded px-4 py-2.5 text-sm text-[#E8E4DE] placeholder-[#5A5652] focus:outline-none focus:border-[#C84B31] transition-colors"
            />
            <button className="px-5 py-2.5 bg-[#C84B31] text-white text-sm font-medium rounded hover:bg-[#A63D28] transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {cat.items.map((item) => (
                <Link
                  ...
                  to={item.path}
                  className="group flex items-start gap-4 p-5 bg-[#161616] border border-[#252525] rounded hover:border-[#5A5652] transition-all"
                >
                  <div className="text-[#C84B31] mt-0.5">{ICONS[item.icon]}</div>
                  <div>
                    <h3 className="text-[#E8E4DE] font-medium group-hover:text-[#C84B31] transition-colors">
                      {t(item.labelKey)}
                    </h3>
                    <p className="text-sm text-[#8A8580] mt-1">{t(item.descKey)}</p>
                  </div>
                </Link>
              ))}
            </div>
