...
export default function SecurityPage() {
  ...
  return (
    <PublicLayout>
      <ResourceLayout>
        <h1 className="text-3xl font-bold text-[#E8E4DE] mb-8">{t('resources.security.title')}</h1>

        <div className="space-y-6">
          {sections.map((section) => (
            <div key={section.key} className="p-6 bg-[#161616] border border-[#252525] rounded">
              <div className="flex items-start gap-4">
                <div className="text-[#C84B31] flex-shrink-0 mt-0.5">
                  {ICONS[section.icon]}
                </div>
                <div>
                  <h2 className="text-lg font-semibold text-[#E8E4DE] mb-2">
