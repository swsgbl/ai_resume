...
class GiteeOAuthProvider(OAuthProvider):
    ...
    def __init__(self):
        ...
        self.default_redirect_uri = getattr(settings, 'GITEE_REDIRECT_URI',
                                            'http://localhost:8000/api/v1/auth/oauth/gitee/callback')
...
class DiscordOAuthProvider(OAuthProvider):
    ...
    def __init__(self):
        ...
        self.default_redirect_uri = getattr(settings, 'DISCORD_REDIRECT_URI',
